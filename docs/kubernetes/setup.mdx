...
| Externally managed certificate Secrets | No | Refer to [Managing Certificates](/kubernetes/managing-certificates). Use this mode when another system or controller creates PEM/X.509-backed Secrets and OpenShell only consumes them. |
